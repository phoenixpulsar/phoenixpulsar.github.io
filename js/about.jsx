...
const PP_ABOUT = {
  tldr: {
    label: "TL;DR",
    blocks: [
      { t: "lead", x: "I build strange, useful software: bots, AI tools, data interfaces, games, on-chain experiments, and small machines that remove friction from modern life." },
    ],
  },
  small: {
    label: "Small",
