          ...
          <div className="hub-field">
            ...
            {!isSpine && index && (
              <div className="hub-bio" style={{ left: index.bio.x, top: index.bio.y, width: index.bio.w, opacity: bioOpacity, pointerEvents: bioOn ? "auto" : "none" }}>
                ...
                <p className="hb-lead">I build strange, useful software: bots, AI tools, data interfaces, games, on-chain experiments, and small machines that remove friction from modern life.</p>
